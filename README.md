...
1. JAVA
   - Core
     ...
     - Garbage collector, Memory management, memory allocate. tuning GC1.
       ...
       tuning JVM: visualVM, jmap -histo:live 7544, jConsole, Profiling tools  
...
9. Clean Code and Uncle Bob, Craftmanship, Refactoring
   ...
   - DDD [[link](https://medium.com/microtica/the-concept-of-domain-driven-design-explained-3184c0fd7c3f)], [[link](https://medium.com/raa-labs/part-1-domain-driven-design-like-a-pro-f9e78d081f10)]
