...
1. JAVA
   - Core
     ...
     - Equals & HashCode, hashCode & equals contract? busket 1, 2, hashcode collision, if two objects equal then hashcode should be the same, https://medium.com/coding-corpus/java-important-methods-equals-hashcode-and-compareto-6adcdf2814c3
     ...
     - Garbage collector, Memory management, memory allocate. heap=objects, permgen(metaspace):classes, static, string pool. stack: primitive objects, references. https://diptendud.medium.com/java-memory-management-interview-questions-and-answers-204d7a249019
     - class Objects.
   - Streams
     ...
     - repeat Streams, map, multiply, reduce, groupby, summarise, max, min, Function interfaces? https://www.youtube.com/watch?v=o1H6kMlCQ74&ab_channel=Bobocode, https://medium.com/swlh/java-collectors-and-its-20-methods-2fc422920f18, 
   - Threads
     - volatile
     - Singleton class
...
4. ORM
   ...
   - N + 1 problem?
   - JPA relationship 1-n, n-1, @Entity, other annotation links tables? department-employee. https://medium.com/thefreshwrites/manytoone-onetomany-mapping-in-jpa-32581d3c0f8a, https://www.baeldung.com/jpa-one-to-one, https://www.tutorialspoint.com/jpa/jpa_entity_relationships.htm
...
6. Microservices
   ...
   - how did you specify the boundaries of your microservices. https://blog.bitsrc.io/how-to-choose-microservices-boundaries-5c68b0b1af24, https://nathanpeck.com/making-microservice-boundaries-that-you-wont-regret/, https://codeburst.io/microservice-boundaries-five-characteristics-to-guide-your-design-89312b65cc27, https://www.linkedin.com/advice/0/how-do-you-identify-boundaries-microservices-from, https://www.linkedin.com/advice/3/how-do-you-set-microservice-boundaries-skills-software-design#:~:text=One%20of%20the%20first%20steps,inventory%20management%2C%20or%20payment%20processing., https://www.oreilly.com/library/view/microservices-up-and/9781492075448/ch04.html, https://www.lokajittikayatray.com/post/how-to-define-your-microservices-correctly
...
9. Clean Code and Uncle Bob, Craftmanship
   - Better organization, Less code duplication, Easier maintenance.
   ...
   - code refactoring how to? understandable, readable, structured, documented
   - TDD
